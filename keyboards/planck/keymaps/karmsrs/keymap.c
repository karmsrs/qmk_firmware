...
#define MT_ENTER MT(MOD_RSFT, KC_ENT)
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MT_ENTER,
 ...
 * |      |   1  |   2  |   3  |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Exit |   0  |      |   .  |Enter |      |      |      | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_NUMPAD] = LAYOUT_planck_grid(
    ...
    EXT_NUM, KC_KP_0, XXXXXXX, KC_KP_DOT, KC_KP_ENTER, XXXXXXX,        XXXXXXX, LOWER,   _______, _______, _______, _______,
)
